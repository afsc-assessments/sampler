DATA_SECTION
 ...
 LOCAL_CALCS
   ...
   ofstream catage_out("catage"+year+".rep");
   ofstream catage_out_str("catage"+year+"_str.rep");
   ofstream  wtage_out("wtage"+year+".rep");
   ofstream  wtage_out_str("wtage"+year+"_str.rep");
   ofstream lf_out("LF_"+year+".rep");
   ofstream alk_out("alk_"+year+".rep");
